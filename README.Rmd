...
The **socialSim R package** provides tools to simulate and analyse datasets of social interactions between individuals using hierarchical Bayesian models implemented in Stan. This packages accompanies [Wijnhorst et al. (2026)](https://doi.org/10.1093/jeb/voag013) *J. Evol. Biol.*, which details the underlying statistical models.
...
See [Wijnhorst et al. (2026)](https://doi.org/10.1093/jeb/voag013) *J. Evol. Biol.* for detailed explanation of the models.
